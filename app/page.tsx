      ...
      <div className="relative flex flex-col items-center gap-8 px-6 text-center" style={{ zIndex: 3 }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 w-full max-w-2xl">
          <a
            ...
            className="flex items-center justify-center gap-3 rounded-full bg-indigo-600 px-6 py-3.5 text-sm font-semibold text-white shadow-lg shadow-indigo-500/30 transition-all duration-300 hover:bg-indigo-500 hover:shadow-indigo-500/50 hover:scale-105 active:scale-95"
          >
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 rounded-full border border-indigo-500/40 bg-white/5 px-6 py-3.5 text-sm font-semibold text-indigo-300 backdrop-blur-sm transition-all duration-300 hover:bg-indigo-500/20 hover:border-indigo-400 hover:text-white hover:scale-105 active:scale-95"
          >
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 rounded-full border border-purple-500/40 bg-white/5 px-6 py-3.5 text-sm font-semibold text-purple-300 backdrop-blur-sm transition-all duration-300 hover:bg-purple-500/20 hover:border-purple-400 hover:text-white hover:scale-105 active:scale-95"
          >
